          ...
          <ListItem thumbnail>
            <Left>
              <Thumbnail
                ...
                source={{
                  uri:
                    'https://n4.sdlcdn.com/imgs/i/1/l/Oppo-A5-2020-64GB-4-SDL344663750-1-bd198.png',
                }}
              />
            </Left>
            <Body>
              <Text>Oppo</Text>
              <Text note numberOfLines={3}>
                Oppo (Black,8GB RAM, 128GB Storage)
              </Text>
              <View style={{flexDirection: 'row', marginTop: 5}}>
                <FAIcon name="star" style={{fontSize: 15, color: 'orange'}} />
                <FAIcon name="star" style={{fontSize: 15, color: 'orange'}} />
          ...
          <ListItem thumbnail>
            <Left>
              <Thumbnail
                ...
                source={{
                  uri:
                    'https://advancetelecom.com.pk/wp-content/uploads/2017/11/Nokia-2-Black-Front.png',
                }}
              />
            </Left>
            <Body>
